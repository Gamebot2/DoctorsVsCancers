...
class Game:
    ...
    def init_cards(self):
        ...
        self.doctor_deck.append(Card(98, "Paclitaxel", "D2PC", "Doctor", "TREATMENT", 2, "Treats major attack in lung or breast", "taxanes are most common cytotoxics in lung and breast, all cause neuropathy", 0, ["Lung", "Breast"], [], "", [], 0))
        ...
        self.doctor_deck.append(Card(101, "5FU / Capecitabine", "D25F", "Doctor", "TREATMENT", 2, "Treats major attack in pancreas", "most common cytotoxics in GI malignancies, capecitabine is oral form, causes hand foot syndrome and diarrhea", 0, ["Pancreatic"], [], "", [], 0))
        ...
        self.doctor_deck.append(Card(105, "Immunotherapy", "D2IM", "Doctor", "TREATMENT", 2, "Treats major attack in lung", "PDL1 inhibitors used in lung, melanoma, renal, and other.  Activate T cells, cause auto-immune problems", 0, ["Lung"], [], "", [], 0))
